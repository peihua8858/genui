...
class GoogleGenerativeAiClient implements AiClient {
  ...
  @override
  Stream<A2uiMessage> get a2uiMessageStream => transport.incomingMessages;

  /// A stream of text responses from the agent.
  @override
  Stream<String> get textResponseStream => transport.incomingText;
...
With functions:
  ...
  Future<Object?> fakeResponse() async {
